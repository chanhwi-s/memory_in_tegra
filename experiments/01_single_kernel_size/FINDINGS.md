...
Generated 2026-07-24T12:24:08Z from `experiments/01_single_kernel_size/results/phase1_results.csv`. All numbers below
...
- **Measured DRAM peak:** 177.4 GB/s

## Reuse crossover

Reuse stops lifting achieved BW above DRAM peak once read_footprint_bytes >= 4194304 (~4.0 MB); below that, higher reuse_N pushes BW above the 177 GB/s measured DRAM peak via cache hits.
...
- 131,072 bytes/buffer -> 32 blocks
...
256 threads/block confirmed near-optimal at the mid-size check (values: {128: 152.321, 256: 255.667, 512: 167.006})
