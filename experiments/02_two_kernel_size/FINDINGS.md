...
Generated 2026-07-27T10:20:30Z from `experiments/02_two_kernel_size/results/phase2_results.csv`. All numbers below are
...
- **Per-kernel size (worst measured contention):** 851,968 bytes (~0.81 MB)
- **Combined read footprint:** 3,407,872 bytes
- **scaling_efficiency at this point (local minimum):** 0.2654
...
- {'mode': 'symmetric', 'per_kernel_bytes': 851968}
...
- At the largest tested size (96.00 MB): reuse N=32 aggregate = 190.1 GB/s.
- At the smallest tested size (128.0 KB): reuse N=32 aggregate = 25.7 GB/s vs N=1 = 13.1 GB/s (+97% from reuse).
...
- At the smallest tested size (256.0 KB): reuse N=32 aggregate = 293.9 GB/s vs N=1 = 197.9 GB/s (+49% from reuse).
